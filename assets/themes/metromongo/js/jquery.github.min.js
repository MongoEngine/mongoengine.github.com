(function ($, window, document, undefined) {
    ...
    Github.prototype = {
        ...
        view_layout: function (user, options) {
            ...
            markup += '<div id="ghw-github">';
            markup += '<div id="ghw-header" class="ghw-clear">';
            markup += '<div id="ghw-logo"><span class="icon icon-github"></span><a href="https://github.com/MongoEngine">Github</a></div>';
            ...
            if (options.show_extended_info === true) {
                ...
                markup += '</p>';
                if (typeof user.bio === "string" && user.bio && user.bio.length > 0) {
